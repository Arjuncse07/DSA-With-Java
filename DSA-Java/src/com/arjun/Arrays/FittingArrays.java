...
there exists a solution such that i'th 
element of arr[ ] is less than or equal to i'th element of brr[ ], for each i, 0 <= i < n. 
Help Geek find if the given array arr[ ] will fit in array brr[ ] or not.
*/
public class FittingArrays {
	  ...
	  public static void main(String[] args) {
		  ...
		  int arr[]= {7,5,3,2};
		  int brr[]= {5,4,8,7};
		FittingArrays.isFit(arr,brr,n);
		System.out.println("Fitted Array are:"+FittingArrays.isFit(arr,brr,n));
	}
}
